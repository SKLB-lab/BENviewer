...
<head>
   ...
   <title>BENviewer - Choose Data</title>
...
<body>
   ...
   <div class="container">
      <div class="metro panorama" style="height: 663px;">
         <div class="panorama-sections" style="width: 2390px; height: 826px; margin-left: 0px;">
            <div class="panorama-section tile-span-4">
               <h2>Choose the Gene-list</h2><br>
               <a class="tile wide imagetext bg-color-blue" href="./upload.php">
                  <div class="image-wrapper">
                     <img height=80 width=80 src="../../assets/img/upload.png">
                  </div>
                  <div class="column-text">
                     ...
                     <div class="text">
                        interested gene-list and
                     </div>
                     <div class="text">
                        make visualization.
                     </div>
                  </div>
                  <span class="app-label">Upload Own</span>
               </a>
               <a class="tile wide imagetext bg-color-blueDark" href="./list.php">
                  <div class="image-wrapper">
                     <img height=80 width=80 src="../../assets/img/list.png">
                  </div>
                  <div class="column-text">
                     <div class="text"></div>
                     <div class="text">
                     ...
                     <div class="text">
                        datasets involving over
                     </div>
                     <div class="text">
                        2000 functions/pathways.
                     </div>
                  </div>
                  <span class="app-label">Use Prepared</span>
               </a>
            </div>
         </div>
      </div>
